// ============================================================================
// GPU Conv2D Energy Benchmark for RTX 3090 with cuDNN
// Operation: 2D Convolution (NCHW layout)
// ============================================================================
// Compile: nvcc -O3 -std=c++17 -o conv2d_3090 main.cu -lcudnn -lnvidia-ml
// Usage: ./conv2d_3090 [--test|-t] [--output|-o <path>] [--device|-d <id>]
...
int main(int argc, char** argv) {
    ...
    int device_id = 0;
    std::string output_file = "data/raw/Conv2D_3090.csv";
    ...
    std::cout << "\nCUDA Conv2D Energy Benchmark (RTX 3090)\n";
