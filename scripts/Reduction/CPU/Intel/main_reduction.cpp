    ...
    return syscall(__NR_perf_event_open, hw_event, pid, cpu, group_fd, flags);
                            ...
                            double computeTotalEnergyDelta(const std::vector<unsigned long long>& before,
                                ...
                                return any_valid ? total_j : -1.0;
                                                           ...
                                                           // ============================================================================
                                                           // Adaptive Batch Size Determination (equivalent to main.cpp logic)
                                                           // ============================================================================
                                                           ...
                                                           MeasurementResult run_single_measurement(const float* x, const float* ones, int n, int batches,
                                                               ...
                                                               // Execute batched reduction - this is the ONLY code measured by perf counters
                                                               run_batched_reduction(x, ones, n, batches);
                                                               ...
                                                               return result;
                                                                                                    ...
                                                                                                    void writeCSVRow(std::ofstream& file, int run_id_global, int run_id_per_size,
                                                                                                        ...
                                                                                                        // For reduction (cblas_sdot): 2 FLOPs per element (multiply + add)
                                                                                                        ...
                                                                                                        << cpu_cache_misses << "\n";
                                                                                                                                 ...
                                                                                                                                 for (int n : sizes_to_test) {
                                                                                                                                     ...
                                                                                                                                     for (int rep = 0; rep < REPEATS; rep++) {
                                                                                                                                         ...
                                                                                                                                         MeasurementResult result = run_single_measurement(x_max, ones_max, n,
                                                                                                                                                                                           batches, rapl_zones, perf_counter);

                                                                                                                                         // below_target: computed per-run based on actual measured time
                                                                                                                                         // (exactly like main.cpp: below_target = (compute_time_s < TARGET_RUNTIME_S))
                                                                                                                     ...
                                                                                                                     // ============================================================================
                                                                                                                     /*
                                                                                                                      * [✓] Adaptive batch size based on TARGET_RUNTIME_S (equivalent to main.cpp logic)
                                                                                                                      * [✓] CSV output according to CSV_COLUMNS.md (30 columns: 26 base + 4 perf counters)
                                                                                                                      ...
                                                                                                                      * [✓] Hardcoded thread counts: 1, 2, 4, 8, 10, 16, 20, 32, 64
                                                                                                                      ...
                                                                                                                      * [✓] below_target flag: 't' if compute_time_s < TARGET_RUNTIME_S (per-run check)
                                                                                                                      * [✓] FLOPs calculation: 2 FLOPs per element (cblas_sdot does mul + add)
                                                                                                                      * [✓] Loop order: outer=num_threads, inner=problem_size, innermost=REPEATS
                                                                                                                      * [✓] run_id_per_size: resets to 1 for each problem_size, increments per run (like GEMM)
                                                                                                                      * [✓] Perf counters (columns 27-30): cpu_cycles, cpu_instructions, cpu_ipc, cpu_cache_misses
                                                                                                                      * [✓] Perf counter measurement window exactly matches time/energy measurement window
                                                                                                                      */
