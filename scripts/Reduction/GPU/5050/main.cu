// main.cu - CUDA Reduction (DOT with ones) Energy Benchmark for RTX 5050
...
std::string getGPUName(nvmlDevice_t device) {
    ...
    // Extract short model name (e.g., "RTX 5050" from "NVIDIA GeForce RTX 5050")
...
int main(int argc, char** argv) {
    ...
    int total_rows = 0;
    int device_id = 0;
    std::string output_file = "data/raw/Reduction_5050.csv";  // Default
    ...
    std::cout << "\nCUDA Reduction (DOT with ones) Energy Benchmark (RTX 5050)\n";
