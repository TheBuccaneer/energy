...
ROOT_DIR="$SCRIPT_DIR"
SRC="$ROOT_DIR/scripts/CONV2D/main_conv2d.cu"
SIBLING_SRC="$ROOT_DIR/../5060ti/scripts/CONV2D/main_conv2d.cu"
BUILD_DIR="$ROOT_DIR/scripts/CONV2D/.build"
...
manifest="$RUN_DIR/conv2d_3090_${stamp}_manifest.txt"
...
for ((session=1; session<=SESSIONS; session++)); do
    ...
    session_id="conv2d_3090_${stamp}_session${session}"
