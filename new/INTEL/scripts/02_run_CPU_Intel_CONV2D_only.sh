...
SEED_BASE=$((0x434F4E5600000000))
QUICK_SEED=$((0x434F4E5600000900))
ANTI_SEED=$((0x434F4E56000009A0))
VERBOSE_PROBE_SEED=$((0x434F4E56000009B0))
...

{
    ...
    echo "official_rows_total=$((SESSIONS * 6 * 7 * REPS))"
