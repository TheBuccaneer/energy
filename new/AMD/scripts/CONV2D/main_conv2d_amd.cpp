// CONV2D CPU benchmark (AMD) -- oneDNN convolution_auto, FP32 forward
...
//
// This file must remain semantically identical to the INTEL sibling after
...
int main(int argc, char** argv) {
    try {
        const bench::Options options =
            bench::parse_options(argc, argv, "conv2d_amd.csv");
