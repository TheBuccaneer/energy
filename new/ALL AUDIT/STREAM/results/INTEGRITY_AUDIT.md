# Independent integrity audit — STREAM
...
| ALL        | semantics  | logical_bandwidth_scope           | WARN       | WARN     | 12*N/runtime             | not measured physical traffic        |
...
| ALL        | identity   | edp                               | FAIL       | PASS     | max_abs_error=2.220e-16  | <1e-12                               |
| ALL        | identity   | throughput                        | FAIL       | PASS     | max_abs_error=5.684e-14  | <1e-12                               |
| ALL        | identity   | efficiency                        | FAIL       | PASS     | max_abs_error=2.220e-16  | <1e-12                               |
| ALL        | leaders    | runtime_equals_bandwidth_exact    | FAIL       | PASS     | 0                        | 0                                    |
| ALL        | leaders    | energy_equals_bytes_per_j_exact   | FAIL       | PASS     | 0                        | 0                                    |
| ALL        | pairwise   | ratio_identity                    | FAIL       | PASS     | max_abs_error=2.842e-14  | <1e-12                               |
